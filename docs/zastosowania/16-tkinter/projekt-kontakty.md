...
Aplikację okienkową trzeba dostarczyć użytkownikowi, który nie zainstaluje Pythona ani pakietów — o pakowaniu i dystrybucji mówi następny rozdział <!-- TODO: link po powstaniu rozdziału o pakowaniu i dystrybucji -->, a projekt ścieżki połączy okno z bazą danych i API z poprzednich rozdziałów w jeden program <!-- TODO: link po powstaniu rozdziału o projekcie aplikacji -->.
