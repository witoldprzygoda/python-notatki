...
[Następny rozdział](../21-scraping/index.md) buduje narzędzia, które sięgają po dane do sieci — pobierają strony klientem httpx z rozdziału 14 i wyciągają z nich informacje parserem HTML; [projekt ścieżki](../23-projekt-automatyzacja/index.md) połączy pobieranie, przetwarzanie i raport w jedno narzędzie wiersza poleceń zbudowane według reguł z tego rozdziału.
