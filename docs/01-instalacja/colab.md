...
Google Colab oferuje dostęp do procesorów graficznych **GPU** (ang. *Graphics Processing Unit*) oraz tensorowych **TPU** (ang. *Tensor Processing Unit*), dzięki czemu dobrze sprawdza się w pracy nad kodem z dziedziny uczenia maszynowego (ang. *machine learning*).

!!! info "Plany płatne"
    Dostępne są również płatne plany, zapewniające większą moc obliczeniową
    i wydajniejsze procesory graficzne.
