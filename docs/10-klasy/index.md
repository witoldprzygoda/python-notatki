...
Materiał obiektowy zajmuje trzy rozdziały. Ten wprowadza rdzeń: definicję klasy, atrybuty instancji i klasy, trzy rodzaje metod, właściwości i konwencje hermetyzacji, dziedziczenie pojedyncze z funkcją `super()` oraz własne klasy wyjątków — pierwsze praktyczne zastosowanie dziedziczenia, zapowiedziane w rozdziale 8. Metody specjalne, dzięki którym obiekty własnych klas współpracują z operatorami, funkcją `len()`, pętlą `for` i instrukcją `with`, omawia rozdział [11. Model danych — metody specjalne i protokoły](../11-model-danych/index.md); dziedziczenie wielokrotne, klasy abstrakcyjne, klasy danych i wzorce projektowe (ang. *design patterns*) — rozdział [12. Programowanie obiektowe — mechanizmy zaawansowane](../12-oop-zaawansowane/index.md). Ostatni podrozdział, o cyklu życia obiektu, ma charakter uzupełniający: tłumaczy, co dzieje się między wywołaniem klasy a zwolnieniem pamięci, i można go pominąć przy pierwszej lekturze.
