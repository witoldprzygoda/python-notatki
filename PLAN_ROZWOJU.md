...
2. **Rozdziały 6–8 są ukończone** (odbiór 5 IX, 12 IX i 13 IX 2026). **Następny do realizacji: rozdział 9. Wejście, wyjście i pliki** — od projektu stron. Rozdziały 9–18 są zaplanowane, ale nie rozpoczęte.
